...
function redirectDirect(){
    ...
    localStorage.handicape = 0;
    window.location.href="Direct/acceuil.html"
}
//==========================================================================================================================================
function redirectNouvelle(){
    
    localStorage.handicape = 0;
    window.location.href="MNouvelles/acceuil.html"
}
//==========================================================================================================================================
function redirectHandicape(){
    window.location.href="Handicape/acceuil.html"
}
 //==========================================================================================================================================
//validate the telephone as the user is inputing it 
